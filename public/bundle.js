...
var expenseReducerDefaultState = [];

var expenseReducer = function expenseReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : expenseReducerDefaultState;
...
var ex1 = store.dispatch(addExpense({ description: 'rent', note: 'this is a note', amount: 100, createdAt: 0 }));
store.dispatch(addExpense({ description: 'rent 2', note: 'this is a note 2', amount: 100, createdAt: 0 }));
